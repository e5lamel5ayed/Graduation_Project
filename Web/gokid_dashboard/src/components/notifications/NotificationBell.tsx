  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="relative p-2 rounded-full text-gray-500 hover:text-[#5c5163] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#b9a2c5] transition-colors"
      >
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-96 max-w-[90vw] rounded-2xl border border-gray-100 bg-white shadow-xl z-50">
